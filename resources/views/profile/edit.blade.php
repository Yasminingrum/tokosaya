                ...
                <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data" x-data="profileForm">
                    ...
                    <div class="card shadow-sm mb-4">
                        ...
                        <div class="card-body">
                            <div class="row align-items-center">
                                <div class="col-auto">
                                    <div class="profile-picture-upload" x-data="{ preview: '{{ auth()->user()->avatar ?: asset('images/default-avatar.jpg') }}' }">
                                        <div class="avatar-preview">
                                            <img :src="preview" alt="Profile Picture" class="avatar-image rounded-circle">
                                ...
                                <div class="col">
                                    <h6 class="mb-2">Upload a new profile picture</h6>
                                    <p class="text-muted mb-2">
                                        Your profile picture helps others recognize you. Choose a clear photo of yourself.
                                    </p>
                                    <div class="upload-requirements">
                                        <small class="text-muted">
                                            <i class="fas fa-info-circle me-1"></i>
                                            Supported formats: JPG, PNG, GIF • Max size: 5MB • Recommended: 400x400px
                                        </small>
                                    </div>
                                    @error('avatar')
                        ...
                        <div class="card-body">
                                    ...
                                    @if(!auth()->user()->email_verified_at)
                                        <div class="mt-2">
                                            <small class="text-warning">
                                                ...
                                                Email not verified.
                                                <a href="{{ route('verification.send') }}" class="text-primary">Resend verification</a>
                                            </small>
                                        </div>
                                    @endif
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="form-text">
                                        <i class="fas fa-info-circle me-1"></i>
                                        We use this to send you birthday offers
                                    </div>
                                </div>
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select @error('gender') is-invalid @enderror"
                                        ...
                                        <option value="O" {{ old('gender', auth()->user()->gender) === 'O' ? 'selected' : '' }}>Other</option>
                                    </select>
                                    @error('gender')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="preferences-group mb-4">
                                    ...
                                    <div class="form-check form-switch mb-2">
                                        <input class="form-check-input"
                                               type="checkbox"
                                               id="newsletter_deals"
                                               name="preferences[newsletter_deals]"
                                               {{ auth()->user()->preferences['newsletter_deals'] ?? false ? 'checked' : '' }}>
                                        <label class="form-check-label" for="newsletter_deals">
                                            <strong>Special Deals & Offers</strong>
                                            <br><small class="text-muted">Get notified about exclusive discounts and promotions</small>
                                        </label>
                                    </div>
                                    <div class="form-check form-switch mb-2">
                                        <input class="form-check-input"
                                               type="checkbox"
                                               id="newsletter_products"
                                               name="preferences[newsletter_products]"
                                               {{ auth()->user()->preferences['newsletter_products'] ?? false ? 'checked' : '' }}>
                                        <label class="form-check-label" for="newsletter_products">
                                            <strong>New Products</strong>
                                            <br><small class="text-muted">Be the first to know about new arrivals</small>
                                        </label>
                                    </div>
                                    <div class="form-check form-switch mb-2">
                                        <input class="form-check-input"
                                               type="checkbox"
                                               id="newsletter_tips"
                                               name="preferences[newsletter_tips]"
                                               {{ auth()->user()->preferences['newsletter_tips'] ?? false ? 'checked' : '' }}>
                                        <label class="form-check-label" for="newsletter_tips">
                                            <strong>Tips & Guides</strong>
                                            <br><small class="text-muted">Helpful content and product guides</small>
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="preferences-group mb-4">
                                    ...
                                    <div class="form-check form-switch mb-2">
                                        <input class="form-check-input"
                                               ...
                                               name="preferences[notify_order_updates]"
                                               {{ auth()->user()->preferences['notify_order_updates'] ?? true ? 'checked' : '' }}>
                                        <label class="form-check-label" for="notify_order_updates">
                                            <strong>Order Updates</strong>
                                            <br><small class="text-muted">Status changes, shipping notifications</small>
                                        </label>
                                    </div>
                                    <div class="form-check form-switch mb-2">
                                        <input class="form-check-input"
                                               type="checkbox"
                                               id="notify_wishlist"
                                               name="preferences[notify_wishlist]"
                                               {{ auth()->user()->preferences['notify_wishlist'] ?? true ? 'checked' : '' }}>
                                        <label class="form-check-label" for="notify_wishlist">
                                            <strong>Wishlist Alerts</strong>
                                            <br><small class="text-muted">Price drops and stock availability</small>
                                        </label>
                                    </div>
                                    <div class="form-check form-switch mb-2">
                                        <input class="form-check-input"
                                               type="checkbox"
                                               id="notify_reviews"
                                               name="preferences[notify_reviews]"
                                               {{ auth()->user()->preferences['notify_reviews'] ?? true ? 'checked' : '' }}>
                                        <label class="form-check-label" for="notify_reviews">
                                            <strong>Review Reminders</strong>
                                            <br><small class="text-muted">Reminders to review purchased products</small>
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="preferences-group">
                                    ...
                                    <div class="form-check form-switch mb-2">
                                        <input class="form-check-input"
                                               ...
                                               {{ auth()->user()->preferences['profile_public'] ?? false ? 'checked' : '' }}>
                                        <label class="form-check-label" for="profile_public">
                                            <strong>Public Profile</strong>
                                            <br><small class="text-muted">Allow others to see your profile and reviews</small>
                                        </label>
                                    </div>
                                    <div class="form-check form-switch mb-2">
                                        <input class="form-check-input"
                                               type="checkbox"
                                               id="show_purchase_activity"
                                               name="preferences[show_purchase_activity]"
                                               {{ auth()->user()->preferences['show_purchase_activity'] ?? false ? 'checked' : '' }}>
                                        <label class="form-check-label" for="show_purchase_activity">
                                            <strong>Show Purchase Activity</strong>
                                            <br><small class="text-muted">Display recent purchases on your public profile</small>
                                        </label>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card shadow-sm mb-4">
                        ...
                        <div class="card-body">
                            <p class="text-muted mb-4">
                                Connect your social media accounts for easier login and to share your favorite products.
                            </p>
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="instagram_username" class="form-label">
                                        <i class="fab fa-instagram me-2"></i>Instagram Username
                                    </label>
                                    <div class="input-group">
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="twitter_username" class="form-label">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text"
                                               ...
                                               value="{{ old('twitter_username', auth()->user()->twitter_username) }}"
                                               placeholder="username">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="form-actions">
                        <div class="row">
                            ...
                            <div class="col-auto">
                                <div class="save-status" x-show="lastSaved">
                                    <small class="text-muted">
